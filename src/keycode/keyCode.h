...
namespace KC
{
    ...
    // static const CustomKey SMKEY_NEXT_TRACK = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_NEXT_TRACK};
    // static const CustomKey SMKEY_PREVIOUS_TRACK = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_PREVIOUS_TRACK};
    // static const CustomKey SMKEY_STOP = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_STOP};
    // static const CustomKey SMKEY_PLAY_PAUSE = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_PLAY_PAUSE};
    // static const CustomKey SMKEY_MUTE = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_MUTE};
    // static const CustomKey SMKEY_VOLUME_UP = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_VOLUME_UP};
    // static const CustomKey SMKEY_VOLUME_DOWN = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_VOLUME_DOWN};
    // static const CustomKey SMKEY_WWW_HOME = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_WWW_HOME};
    // static const CustomKey SMKEY_LOCAL_MACHINE_BROWSER = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_LOCAL_MACHINE_BROWSER};
    // static const CustomKey SMKEY_CALCULATOR = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_CALCULATOR};
    // static const CustomKey SMKEY_WWW_BOOKMARKS = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_WWW_BOOKMARKS};
    // static const CustomKey SMKEY_WWW_SEARCH = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_WWW_SEARCH};
    // static const CustomKey SMKEY_WWW_STOP = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_WWW_STOP};
    // static const CustomKey SMKEY_WWW_BACK = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_WWW_BACK};
    // static const CustomKey SMKEY_CONSUMER_CONTROL_CONFIGURATION = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_CONSUMER_CONTROL_CONFIGURATION};
    // static const CustomKey SMKEY_EMAIL_READER = {KeyType::MEDIA_KEY, (void*) &KEY_MEDIA_EMAIL_READER};
